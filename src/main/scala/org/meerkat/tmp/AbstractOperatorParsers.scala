...
//  
//  type AbstractOperatorSequence[+T] = ((Prec, Prec) => AbstractSequenceBuilder[T]) {
//    def infix: Boolean; def prefix: Boolean; def postfix: Boolean   
//    def assoc: Assoc.Assoc
//  }
//  
//  type AbstractOperatorAlternation[+T] = (Prec => AbstractAlternationBuilder[T])
//  
//  type AbstractOperatorSymbol[+T] = (Prec => AbstractSymbol[T])
//  
//  type AbstractOperatorNonterminal[+T] = (Prec => AbstractNonterminal[T])
//  
//  type Head = AbstractOperatorNonterminal[Any]
//  
//  type AbstractOperatorSequenceBuilder[+T] = (Head => AbstractOperatorSequence[T])
//  type AbstractOperatorAlternationBuilder[+T] = ((Head, Group) => (Group => AbstractOperatorAlternation[T], Group, Option[Group]))
//    
...
//    
//    type AbstractOperatorSequence = ((Prec, Prec) => obj.SequenceBuilder) {
//      def infix: Boolean; def prefix: Boolean; def postfix: Boolean
//      def assoc: Assoc.Assoc
//    }
//    
...
//    implicit val m2: Memoizable[B]
//    
//    type OperatorAlternation <: Prec => obj2.AlternationBuilder
...
//    
//    def seqNt[A,B](p1: AbstractOperatorNonterminal[A], p2: AbstractOperatorNonterminal[B])(implicit builder: CanBuildSequence[A,B]): builder.OperatorSequenceBuilder = {
//      import builder._
//      builderSeq { head =>
...
//        sequence(new Function2[Prec,Prec, obj.SequenceBuilder] { 
...
//    }
//    
//    def seqOpSeqNt[A,B](p1: AbstractOperatorSequenceBuilder[A], p2: AbstractOperatorNonterminal[B])(implicit builder: CanBuildSequence[A,B]): builder.OperatorSequenceBuilder = {
//      import builder._
...
//    }
//    
//    def seqOpSeqSym[A,B](p1: AbstractOperatorSequenceBuilder[A], p2: AbstractSymbol[B])(implicit builder: CanBuildSequence[A,B]): builder.OperatorSequenceBuilder = {
//      import builder._
//      builderSeq { head => val q1 = p1(head)
...
//    }
//    
//    def seqNtSym[A,B](p1: AbstractOperatorNonterminal[A], p2: AbstractSymbol[B])(implicit builder: CanBuildSequence[A,B]): builder.OperatorSequenceBuilder = {
//      import builder._
//      builderSeq { head =>
//        val psx = p1 == head
//        sequence(new Function2[Prec,Prec, obj.SequenceBuilder] { 
...
//    }
//    
//    def seqSymNt[A,B](p1: AbstractSymbol[A], p2: AbstractOperatorNonterminal[B])(implicit builder: CanBuildSequence[A,B]): builder.OperatorSequenceBuilder = {
//      import builder._
//      builderSeq { head =>
...
//    }
//    
//    def seqSeqNt[A,B](p1: AbstractSequenceBuilder[A], p2: AbstractOperatorNonterminal[B])(implicit builder: CanBuildSequence[A,B]): builder.OperatorSequenceBuilder = {
//      import builder._
//      builderSeq { head =>
//        val prx = if (p2 == head) true else false
//        sequence(new Function2[Prec,Prec, obj.SequenceBuilder] { 
...
//    }
//    
//    def altOpAlt[A,B >: A](p1: AbstractOperatorAlternationBuilder[A], p2: AbstractOperatorAlternationBuilder[B])(implicit builder: CanBuildAlternation[A,B]): builder.OperatorAlternationBuilder = {
//      import builder._
...
//    }
//    
//    def altOpAltOpSeq[A,B >: A](p1: AbstractOperatorAlternationBuilder[A], p2: AbstractOperatorSequenceBuilder[B])(implicit builder: CanBuildAlternation[A,B]): builder.OperatorAlternationBuilder = {
//      import builder._
//      builderAlt { (head, group1) =>
//        val s2 = p2(head)
...
//    }
//    
//    def altOpAltOpSym[A,B >: A](p1: AbstractOperatorAlternationBuilder[A], p2: AbstractOperatorSymbol[B])(implicit builder: CanBuildAlternation[A,B]): builder.OperatorAlternationBuilder = {
//      import builder._
//      builderAlt { (head, group1) =>
...
//    }
//    
//    def altOpSeqOpAlt[A,B >: A](p1: AbstractOperatorSequenceBuilder[A], p2: AbstractOperatorAlternationBuilder[B])(implicit builder: CanBuildAlternation[A,B]): builder.OperatorAlternationBuilder = {
//      import builder._
//      builderAlt { (head, group1) =>
...
//    }
//    
//    def altOpSeqOpSym[A,B >: A](p1: AbstractOperatorSequenceBuilder[A], p2: AbstractOperatorSymbol[B])(implicit builder: CanBuildAlternation[A,B]): builder.OperatorAlternationBuilder = {
//      import builder._
//      builderAlt { (head, group1) =>
//        val s1 = p1(head)
...
//    }
//    
//    def altOpSymOpAlt[A,B >: A](p1: AbstractOperatorSymbol[A], p2: AbstractOperatorAlternationBuilder[B])(implicit builder: CanBuildAlternation[A,B]): builder.OperatorAlternationBuilder = {
//      import builder._
//      builderAlt { (head, group1) =>
//        val (f2,opened2,closed2) = p2(head,group1)
...
//    }
//    
//    def altOpSymOpSeq[A,B >: A](p1: AbstractOperatorSymbol[A], p2: AbstractOperatorSequenceBuilder[B])(implicit builder: CanBuildAlternation[A,B]): builder.OperatorAlternationBuilder = {
//      import builder._
//      builderAlt { (head, group1) =>
//        val s2 = p2(head)
...
//    }
//    
//    def altOpSym[A,B >: A](p1: AbstractOperatorSymbol[A], p2: AbstractOperatorSymbol[B])(implicit builder: CanBuildAlternation[A,B]): builder.OperatorAlternation = {
//      import builder._
//      alternation { prec => AbstractParser.altSym(p1(prec), p2(prec)) }
//    }
//    
//    def altSymOpSym[A](p: AbstractSymbol[A]): AbstractOperatorSymbol[A] = prec => p
//    
//    def altSeqOpSeq[A](p: AbstractSequenceBuilder[A]): AbstractOperatorSequenceBuilder[A] 
//      = head => new Function2[Prec,Prec,AbstractSequenceBuilder[A]] {
//                  def apply(prec1: Prec, prec2: Prec) = p
//                  def infix = false; def prefix = false; def postfix = false
//                  def assoc = Assoc.UNDEFINED
//                }
//    
//    def altAltOpAlt[A](p: AbstractAlternationBuilder[A]): AbstractOperatorAlternationBuilder[A]
//      = (head, group1) => (group2 => prec => p, group1, None)
//    
//    /**
//     * If |> is used inside an associativity group, it is ignored, i.e., is equivalent to use of |.
//     */
//    def greaterOpAlt[A,B >: A](p1: AbstractOperatorAlternationBuilder[A], p2: AbstractOperatorAlternationBuilder[B])(implicit builder: CanBuildAlternation[A,B]): builder.OperatorAlternationBuilder = {
//      import builder._
//      builderAlt { (head, group1) =>
//        val (f2,opened2,closed2) = p2(head,group1)
//        if (group1 subgroup) {
...
//    }
//      
//    def greaterOpSeqOpAlt[A,B >: A](p1: AbstractOperatorSequenceBuilder[A], p2: AbstractOperatorAlternationBuilder[B])(implicit builder: CanBuildAlternation[A,B]): builder.OperatorAlternationBuilder = {
//      import builder._
//      builderAlt { (head, group1) =>
//        val (f2,opened2,closed2) = p2(head,group1)
//        val s1 = p1(head)
...
//    }
//    
//    def greaterOpAltOpSeq[A,B >: A](p1: AbstractOperatorAlternationBuilder[A], p2: AbstractOperatorSequenceBuilder[B])(implicit builder: CanBuildAlternation[A,B]): builder.OperatorAlternationBuilder = {
//      import builder._
//      builderAlt { (head, group1) =>
//        val s2 = p2(head)
//        val (level,group) = if (s2.infix || s2.prefix || s2.postfix) group1.level(s2.assoc, if (s2.prefix) -1 else if (s2.postfix) 1 else 0)
...
//    }
//    
//    def greaterOpSeq[A,B >: A](p1: AbstractOperatorSequenceBuilder[A], p2: AbstractOperatorSequenceBuilder[B])(implicit builder: CanBuildAlternation[A,B]): builder.OperatorAlternationBuilder = {
//      import builder._
//      builderAlt { (head, group1) =>
//        val s2 = p2(head)
//        val (l2,g2) = if (s2.infix || s2.prefix || s2.postfix) group1.level(s2.assoc, if (s2.prefix) -1 else if (s2.postfix) 1 else 0)
...
//    }
//    
//    def assocAlt[A](implicit builder: CanBuildAlternation[A,A]): (builder.OperatorAlternationBuilder, Assoc.Assoc) => builder.OperatorAlternationBuilder = {
//      import builder._
//      { (p,a) =>
//          builderAlt { (head,group1) =>
...
//    }
//    
//    object FAIL extends AbstractSequenceBuilder[Nothing] { 
//      def apply(slot: Slot) = new AbstractParser[Nothing] with Slot {
//                                def apply(input: Input, i: Int, sppfLookup: SPPFLookup) = CPSResult.failure
//                                def size = 0
